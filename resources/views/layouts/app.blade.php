    	...
    	<div class="container">
        	...
        	<div class="collapse navbar-collapse" id="navigation-example">
		        ...
		        <!-- <li>
		            ...
		            <li>
		                <a href="https://www.facebook.com/walallica" target="_blank" class="btn btn-simple btn-white btn-just-icon">
							<i class="fa fa-facebook-square"></i>
						</a>
		            </li>
					<li>
		                <a href="https://www.instagram.com/annihileitor" target="_blank" class="btn btn-simple btn-white btn-just-icon">
